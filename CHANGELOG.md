...
- **Интерфейс `neofetch`**: обновлены дизайн и визуальное оформление вывода
  команды (`kernel/shell/apps/neofetch.c`, `include/nexus/font8x16.h`).
- **Подсистема вывода**: проведены адаптация и фикс несовместимостей в
  драйвере фреймбуфера (`drivers/console/console.c`) под новый формат
  и габариты графического вывода `neofetch`.
